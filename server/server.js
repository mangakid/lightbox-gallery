...
// Get first page of "interesting" images
router.route("/images").get(function(req, res) {
  ...
  axios
    .get(
      `https://api.flickr.com/services/rest/?method=flickr.interestingness.getList&api_key=${FLICKR_KEY}&format=json&extras=${extras}&per_page=10`,
    )
    .then(response => {
